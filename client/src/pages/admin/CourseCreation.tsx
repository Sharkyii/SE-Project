...
const CourseCreation = () => {
    ...
    const inputCls = 'w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all';
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="flex items-center gap-3">
                                <button type="button" onClick={() => setIsElective(false)}
                                    className={`px-4 py-2 rounded-lg text-sm font-medium border transition-colors ${!isElective ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-600 border-gray-300 hover:border-gray-400'}`}>
                                    Regular
                                </button>
                                <button type="button" onClick={() => setIsElective(true)}
                                    className={`px-4 py-2 rounded-lg text-sm font-medium border transition-colors ${isElective ? 'bg-purple-600 text-white border-purple-600' : 'bg-white text-gray-600 border-gray-300 hover:border-gray-400'}`}>
                                    Elective
                                </button>
                            </div>
                        </div>
